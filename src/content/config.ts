...
const homepage = defineCollection({
  ...
  schema: z.object({
    ...
    productsSection: z.object({ visible: z.boolean().default(true), eyebrow: z.string(), title: z.string(), description: z.string().optional(), linkLabel: z.string().optional(), linkHref: z.string().optional() }),
    certificationsSection: z.object({
      visible: z.boolean().default(true),
      eyebrow: z.string(),
      title: z.string(),
      description: z.string().optional(),
